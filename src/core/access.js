export const moduleCatalog = [
  ...
  { key: "finance", group: "commercial", label: "Finanzas", description: "Ingresos, egresos, presupuestos y conciliación", symbol: "$", permissionModules: ["finance"] },
  { key: "logistics", group: "commercial", label: "Logística", description: "Preparación, embarque y entrega", symbol: "⇢", permissionModules: ["logistics"] },
  { key: "production", group: "industrial", label: "Producción", description: "Ingeniería, órdenes de trabajo y ejecución", symbol: "⚒", permissionModules: ["production"] },
  { key: "quality", group: "industrial", label: "Calidad", description: "Inspecciones, liberaciones y acciones", symbol: "✓", permissionModules: ["quality"] },
  { key: "maintenance", group: "industrial", label: "Mantenimiento", description: "Equipos, programa anual, OT y costos", symbol: "⚙", permissionModules: ["maintenance"] },
  { key: "hr", group: "administrative", label: "Recursos humanos", description: "Personal, permisos, vacaciones y asistencia", symbol: "♙", permissionModules: ["hr"] },
  { key: "payroll", group: "administrative", label: "N\u00f3mina", description: "Proceso compartido por Recursos Humanos y Finanzas", symbol: "N", permissionModules: ["payroll"] },
  { key: "tasks", group: "additional", label: "Tareas y aprobaciones", description: "Pendientes, flujos y decisiones", symbol: "●", permissionModules: ["tasks", "workflow"] },
  { key: "safety", group: "additional", label: "Seguridad y salud", description: "Riesgos, incidentes y cumplimiento", symbol: "✚", permissionModules: ["safety"] },
];
